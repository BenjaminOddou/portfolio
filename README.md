...
├── .git # Folder containing all git info
...
├── pages # All pages belongs here. Nuxt provides a file-based routing to create routes within the app using Vue Router.
│   ├── [...slug].vue # catch all route (404 not found)
