...
import headSun from '/assets/svgs/head-sun.svg?component'
import headMoon from '/assets/svgs/head-moon.svg?component'
...
<template>
  <div>
    ...
    >
      <logoBO id="logo-bo" class="fill-current stroke-current stroke-[20]" />
    </button>
    ...
    >
      ...
      >
        <div>
          <headSun class="sun origin-center translate-y-0 animate-[20s_linear_infinite_spin] fill-jet stroke-jet dark:translate-y-16 dark:animate-none dark:fill-white dark:stroke-white" />
          <headMoon class="moon translate-y-16 fill-jet stroke-jet dark:translate-y-0 dark:fill-white dark:stroke-white" />
        </div>
      </button>
