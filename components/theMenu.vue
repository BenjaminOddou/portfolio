        ...
        >
          ...
          >
            <NuxtLink
              ...
              no-rel
            >
              <TheSVG name="line-insta" class="fill-jet dark:fill-white" />
            </NuxtLink>
            <NuxtLink
              id="logo-ytube-nav"
              ...
              no-rel
            >
              <TheSVG name="line-ytbe" class="fill-jet dark:fill-white" />
            </NuxtLink>
            <NuxtLink
              id="logo-githb-nav"
              ...
              no-rel
            >
              <TheSVG name="line-git" class="fill-jet stroke-jet dark:fill-white dark:stroke-white" />
            </NuxtLink>
            <NuxtLink
              id="logo-email-nav"
            ...
            >
              <TheSVG name="line-mail" class="fill-jet dark:fill-white" />
            </NuxtLink>
          </div>
        </div>
      </div>
...
.spyne {
  animation: spinned 15s linear infinite;
