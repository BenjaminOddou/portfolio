      ...
      >
        ...
        >
          ...
          <TheSVG
            id="signature"
            name="the-signature"
            class=" m-0 h-[calc(var(--initsize)_*_1.5)] w-[calc(var(--initsize)_*_3)] -translate-x-[calc(var(--initsize)_*_0.9)] -translate-y-[calc(var(--initsize)_*_2.3)] rotate-90 fill-none stroke-current stroke-[5]"
          />
        </div>
        <div
